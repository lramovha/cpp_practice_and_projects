...
void displayFitnessResults(float &bmi)
{
    if (bmi < 18.5)
    {
        cout << "Your Body Mass Index is "<< bmi << " kg/m2 and your Weight status is Underweight" << endl;
    }
    if (bmi >= 18.5 && bmi <=24.9)
    {
        cout << "Your Body Mass Index is "<< bmi << " kg/m2 and your Weight status is Healthy" <<endl;
    }
    if (bmi >= 25.0 && bmi <= 29.9)
    {
        cout << "Your Body Mass Index is "<< bmi << " kg/m2 and your Weight status is Overweight" <<endl;
    }
    if (bmi >= 30.0)
    {
        cout << "Your Body Mass Index is "<< bmi << " kg/m2 and your Weight status is Obese" <<endl;
    }
}
